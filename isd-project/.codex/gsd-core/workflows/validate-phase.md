...
```
Agent(
  prompt="Read C:/Innovative Technology Group/isd-project/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Innovative Technology Group/isd-project/.codex/gsd-core/templates/VALIDATION.md`
