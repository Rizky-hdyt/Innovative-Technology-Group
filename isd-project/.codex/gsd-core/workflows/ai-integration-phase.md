...
<required_reading>
@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/ai-frameworks.md
@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Innovative Technology Group/isd-project/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Innovative Technology Group/isd-project/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Innovative Technology Group/isd-project/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Innovative Technology Group/isd-project/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Innovative Technology Group/isd-project/.codex/agents/gsd-eval-planner.md for instructions.
