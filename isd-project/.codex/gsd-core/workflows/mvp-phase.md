...
<required_reading>
@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/user-story-template.md
@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/spidr-splitting.md
@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/spidr-splitting.md`. Briefly:
