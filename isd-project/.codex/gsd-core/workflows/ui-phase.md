...
```markdown
Read C:/Innovative Technology Group/isd-project/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Innovative Technology Group/isd-project/.codex/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Innovative Technology Group/isd-project/.codex/agents/gsd-ui-checker.md for instructions.
