...
Use template from `C:/Innovative Technology Group/isd-project/.codex/gsd-core/templates/UI-SPEC.md`.
...
Read template: `C:/Innovative Technology Group/isd-project/.codex/gsd-core/templates/UI-SPEC.md`
