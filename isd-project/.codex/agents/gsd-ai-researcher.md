...
<required_reading>
Read `C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
