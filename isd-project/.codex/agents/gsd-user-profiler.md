...
<reference>
@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/user-profiling.md` to load:
