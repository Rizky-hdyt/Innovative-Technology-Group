...
Reference full template: `C:/Innovative Technology Group/isd-project/.codex/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Innovative Technology Group/isd-project/.codex/gsd-core/templates/state.md`.
