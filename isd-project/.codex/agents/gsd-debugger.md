...
<required_reading>
@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Innovative Technology Group/isd-project/.codex
                  → checks C:/Innovative Technology Group/isd-project/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Innovative Technology Group/isd-project/.codex/gsd-core
                  → writes to C:/Innovative Technology Group/isd-project/.codex/gsd-core/hooks/
...
@C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/thinking-models-debug.md
...
- Read @C:/Innovative Technology Group/isd-project/.codex/gsd-core/references/common-bug-patterns.md
